...
Generated **2026-09-07T14:59:44Z** from the checked-in playlist `my-iptv.m3u`.
...
- Playlist channel identities after removing only the `@feed` qualifier: **383**.
- Exact XMLTV channel IDs retained: **47** (12.3%).
...
- **Ukraine**: `https://iptv-epg.org/files/epg-ua.xml.gz`; HTTP `200`, `application/gzip`, Last-Modified `Mon, 07 Sep 2026 14:48:46 GMT`; 231 source channels / 49642 programmes (20260907000000 +0000 → 20260914004500 +0000).
- **Russia**: `https://iptv-epg.org/files/epg-ru.xml.gz`; HTTP `200`, `application/gzip`, Last-Modified `Mon, 07 Sep 2026 14:48:47 GMT`; 223 source channels / 49725 programmes (20260906210000 +0000 → 20260914025000 +0000).
