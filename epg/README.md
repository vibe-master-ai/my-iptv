...
Generated **2026-09-14T09:57:35Z** from the checked-in playlist `my-iptv.m3u`.
...
- Programme events retained: **8433**.
...
- **Ukraine**: `https://iptv-epg.org/files/epg-ua.xml.gz`; HTTP `200`, `application/gzip`, Last-Modified `Mon, 14 Sep 2026 08:14:28 GMT`; 231 source channels / 46841 programmes (20260914000000 +0000 → 20260921000900 +0000).
- **Russia**: `https://iptv-epg.org/files/epg-ru.xml.gz`; HTTP `200`, `application/gzip`, Last-Modified `Mon, 14 Sep 2026 08:14:16 GMT`; 223 source channels / 32217 programmes (20260913210000 +0000 → 20260921014500 +0000).
